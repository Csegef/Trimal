...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2026. Jan 23. 13:01
...
CREATE TABLE `specie` (
  ...
  `base_health` int(11) DEFAULT 5,
  `base_strength` int(11) DEFAULT 5,
  `base_agility` int(11) DEFAULT 5,
  `base_luck` int(11) DEFAULT 5,
