...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2026. Feb 04. 09:38
...
INSERT INTO `environment` (`id`, `name`, `description`, `background`) VALUES
(1, 'forest_background', 'A dense prehistoric forest where towering ancient trees block much of the sunlight. Early human tribes move carefully between massive roots, gathering berries and hunting small animals, while larger beasts roam deeper in the shadows. The air is heavy with mist, insects, and the constant sounds of unseen life.', 'forest_backgroundFULLHD.png'),
(2, 'iceland_background', 'A harsh prehistoric land shaped by ice and fire. Vast glaciers stretch across the horizon, broken by volcanic rock and steaming ground. Early humans survive here through resilience and cooperation, hunting hardy animals that have adapted to the cold and using fire as their greatest ally.', 'iceland_backgroundFULLHD.png'),
(3, 'jungle_background', 'A wild prehistoric jungle overflowing with life. Thick vegetation, giant ferns, and towering trees create a humid, dangerous environment. Early humans navigate this land cautiously, sharing it with powerful predators, colorful birds, and countless creatures hidden within the dense greenery.', 'jungle_backgroundFULLHD.png'),
(4, 'mountain_background', 'A prehistoric mountain region with steep cliffs and narrow paths carved by time. Early humans settle near caves and high vantage points, watching herds move below. Large animals dominate the valleys, while strong winds and thin air test the limits of survival.', 'mountain_backgroundFULLHD.png'),
(5, 'savannah_background', 'A vast prehistoric savannah stretching endlessly under the open sky. Tall grass waves in the wind as early human groups follow migrating herds. Powerful animals rule the plains, and survival depends on teamwork, observation, and the careful use of primitive tools.', 'savannah_backgroundFULLHD.png');
