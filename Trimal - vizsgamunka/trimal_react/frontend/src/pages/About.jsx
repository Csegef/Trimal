            ...
            <section className="space-y-3">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                <div className="bg-stone-800/30 p-4 rounded-lg border border-stone-700">
                  <h3 className=" text-amber-200 mb-2">Character Customization</h3>
                  <p className="text-sm text-stone-300">
                    Create unique characters with different classes, hair styles, and beard options
                  </p>
                </div>
                <div className="bg-stone-800/30 p-4 rounded-lg border border-stone-700">
                  <h3 className="text-amber-200 mb-2">Strategic Gameplay</h3>
                  <p className="text-sm text-stone-300">
                    Engage in tactical battles
                  </p>
                </div>
                <div className="bg-stone-800/30 p-4 rounded-lg border border-stone-700">
                  <h3 className=" text-amber-200 mb-2">Progression System</h3>
                  <p className="text-sm text-stone-300">
