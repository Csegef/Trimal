...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2026. Feb 24. 20:54
...
CREATE TABLE `specie` (
  ...
  `inventory_json` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT json_object('capacity',100,'used',0,'currency',json_object('normal',0,'spec',0),'items',json_array(),'equipped',json_object('weapon',NULL,'armor_head',NULL,'armor_chest',NULL,'armor_legs',NULL,'armor_feet',NULL)) CHECK (json_valid(`inventory_json`)),
...
(1, 6, NULL, 'Neanderthal', 1, 0, 100, 10, 10, 10, 10, 10, 0, '{\r\n  \"capacity\": 100,\r\n  \"used\": 4,\r\n  \"currency\": {\r\n    \"normal\": 0,\r\n    \"spec\": 0\r\n  },\r\n  \"items\": [\r\n    {\r\n      \"id\": 1,\r\n      \"type\": \"weapon\",\r\n      \"name\": \"Stone Axe\",\r\n      \"rarity\": \"Common\",\r\n      \"quantity\": 1,\r\n      \"description\": \"A polished stone head grooved and securely fixed to a sturdy haft.\",\r\n      \"iconPath\": \"rare_axe.png\"\r\n    }\r\n  ],\r\n  \"equipped\": {\r\n    \"weapon\": 1,\r\n    \"armor_head\": null,\r\n    \"armor_chest\": null,\r\n    \"armor_legs\": null,\r\n    \"armor_feet\": null\r\n  }\r\n}', 'n-hair-5', 'n-beard-3', NULL, NULL, NULL, '2026-02-03 18:41:24', '2026-02-11 10:51:39'),
(2, 7, NULL, 'Sapiens', 1, 0, 100, 10, 10, 10, 10, 10, 0, '{\r\n  \"capacity\": 100,\r\n  \"used\": 2,\r\n  \"currency\": {\r\n    \"normal\": 0,\r\n    \"spec\": 0\r\n  },\r\n  \"items\": [\r\n    {\r\n      \"id\": 3,\r\n      \"type\": \"food\",\r\n      \"name\": \"Eye fruit\",\r\n      \"category\": \"agility\",\r\n      \"rarity\": \"legendary\",\r\n      \"quantity\": 1,\r\n      \"description\": \"Strange eye like edible thing that gives you plenty energy\",\r\n      \"iconPath\": \"agility-l.png\",\r\n      \"buff_id\": 12\r\n    },\r\n    {\r\n      \"id\": 2,\r\n      \"type\": \"weapon\",\r\n      \"name\": \"Wooden club\",\r\n      \"rarity\": \"Common\",\r\n      \"quantity\": 1,\r\n      \"description\": \"A heavy branch, knotted and hardened by fire, used for blunt force.\",\r\n      \"iconPath\": \"common_club.png\",\r\n      \"base_damage\": 10\r\n    }\r\n  ],\r\n  \"equipped\": {\r\n    \"weapon\": 2,\r\n    \"armor_head\": null,\r\n    \"armor_chest\": null,\r\n    \"armor_legs\": null,\r\n    \"armor_feet\": null\r\n  }\r\n}', NULL, 'hs-beard-4', NULL, NULL, NULL, '2026-02-03 19:00:02', '2026-02-11 10:51:39'),
(3, 8, NULL, 'Floresiensis', 1, 0, 100, 10, 10, 10, 10, 10, 0, '{\r\n  \"capacity\": 100,\r\n  \"used\": 0,\r\n  \"currency\": {\r\n    \"normal\": 0,\r\n    \"spec\": 0\r\n  },\r\n  \"items\": [],\r\n  \"equipped\": {\r\n    \"weapon\": null,\r\n    \"armor_head\": null,\r\n    \"armor_chest\": null,\r\n    \"armor_legs\": null,\r\n    \"armor_feet\": null\r\n  }\r\n}', 'f-hair-3', 'f-beard-3', NULL, NULL, NULL, '2026-02-03 19:04:54', '2026-02-11 10:51:39'),
(4, 9, NULL, 'Floresiensis', 1, 0, 100, 10, 10, 10, 10, 10, 0, '{\r\n  \"capacity\": 100,\r\n  \"used\": 0,\r\n  \"currency\": {\r\n    \"normal\": 0,\r\n    \"spec\": 0\r\n  },\r\n  \"items\": [],\r\n  \"equipped\": {\r\n    \"weapon\": null,\r\n    \"armor_head\": null,\r\n    \"armor_chest\": null,\r\n    \"armor_legs\": null,\r\n    \"armor_feet\": null\r\n  }\r\n}', 'f-hair-4', 'f-beard-3', NULL, NULL, NULL, '2026-02-03 19:07:01', '2026-02-11 10:51:39'),
(5, 10, NULL, 'Neanderthal', 1, 0, 100, 10, 10, 10, 10, 10, 0, '{\r\n  \"capacity\": 100,\r\n  \"used\": 8,\r\n  \"currency\": {\r\n    \"normal\": 1000,\r\n    \"spec\": 100\r\n  },\r\n  \"items\": [\r\n    {\r\n      \"id\": 16,\r\n      \"type\": \"weapon\",\r\n      \"name\": \"Worn axe\",\r\n      \"rarity\": \"Legendary\",\r\n      \"quantity\": 1,\r\n      \"description\": \"Ancient skull axe, stained dark from countless hunts, its edge unnaturally keen.\",\r\n      \"iconPath\": \"legendary_axe.png\",\r\n      \"base_damage\": 25\r\n    },\r\n    {\r\n      \"id\": 9,\r\n      \"type\": \"armor\",\r\n      \"name\": \"Worn bone boots\",\r\n      \"category\": \"Armor\",\r\n      \"rarity\": \"Legendary\",\r\n      \"quantity\": 1,\r\n      \"description\": \"Soft leather footwear wraps the feet to prevent cuts and reduce pain on rocky ground.\",\r\n      \"iconPath\": \"legendary-boots.png\",\r\n      \"armor_point\": 28\r\n    },\r\n    {\r\n      \"id\": 3,\r\n      \"type\": \"food\",\r\n      \"name\": \"Eye fruit\",\r\n      \"category\": \"agility\",\r\n      \"rarity\": \"legendary\",\r\n      \"quantity\": 1,\r\n      \"description\": \"Strange eye like edible thing that gives you plenty energy\",\r\n      \"iconPath\": \"agility-l.png\",\r\n      \"buff_id\": 12\r\n    },\r\n    {\r\n      \"id\": 6,\r\n      \"type\": \"misc\",\r\n      \"name\": \"Skull of an ungulate\",\r\n      \"category\": \"Misc\",\r\n      \"rarity\": \"Epic\",\r\n      \"quantity\": 1,\r\n      \"description\": \"These are a sight to be hold! Wonder why would someone leave it\",\r\n      \"iconPath\": \"misc-epic2.png\"\r\n    },\r\n    {\r\n      \"id\": 14,\r\n      \"type\": \"weapon\",\r\n      \"name\": \"Bone spear\",\r\n      \"rarity\": \"Epic\",\r\n      \"quantity\": 1,\r\n      \"description\": \"Spear with a long, barbed point made from a straightened horn, fearsome in reach.\",\r\n      \"iconPath\": \"epic_spear.png\",\r\n      \"base_damage\": 20\r\n    },\r\n    {\r\n      \"id\": 1,\r\n      \"type\": \"armor\",\r\n      \"name\": \"Bone boots\",\r\n      \"category\": \"Armor\",\r\n      \"rarity\": \"Epic\",\r\n      \"quantity\": 1,\r\n      \"description\": \"Hard bone soles strapped over leather.\",\r\n      \"iconPath\": \"bone-boots.png\",\r\n      \"armor_point\": 25\r\n    },\r\n    {\r\n      \"id\": 6,\r\n      \"type\": \"food\",\r\n      \"name\": \"Ancient pepper\",\r\n      \"category\": \"strength\",\r\n      \"rarity\": \"legendary\",\r\n      \"quantity\": 1,\r\n      \"description\": \"It looks ancient, wonder why it has a me on it.\",\r\n      \"iconPath\": \"strength-l.png\",\r\n      \"buff_id\": 13\r\n    },\r\n    {\r\n      \"id\": 13,\r\n      \"type\": \"food\",\r\n      \"name\": \"Mead\",\r\n      \"category\": \"resistance\",\r\n      \"rarity\": \"epic\",\r\n      \"quantity\": 1,\r\n      \"description\": \"I get dizzy when drinking too much of this, cannot feel anything though.\",\r\n      \"iconPath\": \"resistance-m.png\",\r\n      \"buff_id\": 10\r\n    },\r\n    {\r\n      \"id\": 5,\r\n      \"type\": \"misc\",\r\n      \"name\": \"Unhacted egg\",\r\n      \"category\": \"Misc\",\r\n      \"rarity\": \"Epic\",\r\n      \"quantity\": 1,\r\n      \"description\": \"Unhacted egg of a bigger bird. It is a rare occurance so it must be celebrated\",\r\n      \"iconPath\": \"misc-epic1.png\"\r\n    }\r\n  ],\r\n  \"equipped\": {\r\n    \"weapon\": null,\r\n    \"armor_head\": null,\r\n    \"armor_chest\": null,\r\n    \"armor_legs\": null,\r\n    \"armor_feet\": null\r\n  }\r\n}', NULL, NULL, 13, 26, 9, '2026-02-03 19:17:53', '2026-02-24 18:55:27');
...
(10, 5, 'feketecsegeistvan-40257@taszi.hu', '$2b$10$RC8i1dQ1aK8AZI4lYWv3OOmdNJJJ.9F8rnG85UaEk5I4UnSr89.pu', '$2b$10$RC8i1dQ1aK8AZI4lYWv3OO', 'gipszjakab55', '2026-02-24', 1, 0, 0, '', NULL, 1);
