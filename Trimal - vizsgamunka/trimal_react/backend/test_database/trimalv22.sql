...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2026. Már 31. 09:43
...
(1, 'Dark confiscator', 'Me saw this giant bird. Bigger than me, much bigger. Wings like a shadow. Other me tried to throw a ', 11, 11, 11, 11, 11, 'argentavis_magnificens_cover.png', 'Light', 'poison'),
(2, 'Cave dweller', 'Big cat. Lives in caves. Yellow eyes in the dark. Me went into a cave once. Never again. Other me we', 14, 14, 14, 14, 14, 'cave_lion_cover.png', 'Medium', 'bleed'),
(3, 'Giant horse', 'Looks like a horse but has claws like a bear. Me thought it was friendly. It was not friendly. Kicke', 17, 17, 17, 17, 17, 'chalicotherium_cover.png', 'Heavy', 'none'),
(4, 'White powder', 'Wolf but bigger. White fur, red eyes. Pack hunter. Me saw five of them staring. Me ran. Other me ran', 11, 11, 11, 11, 11, 'dire_wolf_cover.png', 'Light', 'none'),
(5, 'Furry me', 'Big monkey. Bigger than me, hairier than me. Me threw a rock at it. It threw a whole branch back. Me', 14, 14, 14, 14, 14, 'giant_ape_cover.png', 'Medium', 'none'),
(6, 'Walking rock', 'Turtle but huge. Big dome shell like a rock on legs. Me hit it with an axe. Axe broke. Me cried a li', 14, 14, 14, 14, 14, 'glyptodon_cover.png', 'Medium', 'none'),
(7, 'Digger', 'Big slow bear with long claws. Digs holes bigger than me. Me fell in one hole. Other me laughed. Oth', 17, 17, 17, 17, 17, 'ground_sloth_cover.png', 'Heavy', 'none'),
(8, 'Confiscator', 'Biggest bird that flies. Picks up deer. Picks up me if me not careful. Me stays under trees now. Tre', 11, 11, 11, 11, 11, 'haasts_eagle_cover.png', 'Light', 'bleed'),
(9, 'Treehead', 'Big deer. Huge antlers like a whole tree on its head. Me tried to hide behind a bush. Bush was too s', 17, 17, 17, 17, 17, 'irish_elk_cover.png', 'Heavy', 'none'),
(10, 'Nose', 'Strange animal. Long nose like a snake but on a horse body. Me laughed at its face. It kicked my but', 14, 14, 14, 14, 14, 'macrauchenia_cover.png', 'Medium', 'none'),
(11, 'Longbeak', 'Big bird. Beak long and sharp with bumps like teeth. Me saw it swallow a fish whole. Me is made of m', 11, 11, 11, 11, 11, 'pelagornis_sandersi_cover.png', 'Light', 'bleed'),
(12, 'Plowmouth', 'Strange tusk but mouth flat like a shovel. Digs mud. Digs plants. Could dig me. Me stays on high gro', 17, 17, 17, 17, 17, 'platybelodon_cover.png', 'Heavy', 'none'),
(13, 'Bigrat', 'Rat but bigger. Hops higher than my head. Punches harder than my face. Me lost two teeth. Not from t', 14, 14, 14, 14, 14, 'procoptodon_cover.png', 'Medium', 'none'),
(14, 'Tooth', 'Big cat with two long teeth like daggers coming from its mouth. Me saw it once. Once was enough. Oth', 17, 17, 17, 17, 17, 'sabertooth_tiger_cover.png', 'Heavy', 'bleed'),
(15, 'Death', 'Giant bear. Biggest me ever seen. They call it Death because nothing survives. Me calls it \"nope\". O', 17, 17, 17, 17, 17, 'shortface_bear_cover.png', 'Heavy', 'bleed'),
(16, 'Longneck', 'Strange long neck horse thing but with four horns and thick neck. Looks weird. Hits like a rock. ', 14, 14, 14, 14, 14, 'sivatherium_cover.png', 'Medium', 'none'),
(17, 'Boulder', 'Big hairy cow with thick fur. Lives in cold. Me touched it once. My finger froze. Other me licked it', 17, 17, 17, 17, 17, 'steppe_bison_cover.png', 'Heavy', 'cold'),
(18, 'Running beak', 'Big angry bird that runs fast. No fly, only run and peck. Me outran it... barely. Other me tripped. ', 14, 14, 14, 14, 14, 'terrorbird_cover.png', 'Medium', 'bleed'),
(19, 'Rapid bite', 'Cat with sharp teeth. Bites very fast. Me blinked and already had three new holes in my leg. Blood e', 11, 11, 11, 11, 11, 'thylacoleo_cover.png', 'Light', 'bleed'),
(20, 'Green trunk', 'Big snake. Green like leaves. Me didnt see it. Thats how me got bitten. Felt sick for a week. Other ', 14, 14, 14, 14, 14, 'titanboa_cover.png', 'Medium', 'poison'),
(21, 'Woolly tusk', 'Big hairy tusk with long curved tusks. Lives in snow. Me tried to hide behind a rock. Rock was small', 17, 17, 17, 17, 17, 'woolly_mammoth_cover.png', 'Heavy', 'cold'),
(22, 'Woolly boulder', 'Hairy boulder. Big horn on nose. Big temper. Me hid in a cave. It tried to dig me out with its horn.', 17, 17, 17, 17, 17, 'woolly_rhino_cover.png', 'Heavy', 'cold'),
(23, 'Short tusk', 'Elephant but with short tusks pointing down. Looks funny. Me laughed once. Then it charged. Me ran f', 17, 17, 17, 17, 17, 'deinotherium_cover.png', 'Heavy', 'none');
...
(7, 'Agni flower', 'Misc', 'Legendary', 50, 10, 'Unseen plant. Even the ones with dedication could not tell anything about it. It seems ancient.', 'misc-legendary1.png'),
...
(44, 5, 'herbalist', 'food', 8, '2026-03-31', 0),
...
(5, 10, NULL, 'Neanderthal', 1, 15, 55, 13, 11, 12, 13, 10, 0, '{\"capacity\":200,\"used\":70,\"currency\":{\"normal\":370,\"spec\":100},\"items\":[{\"id\":16,\"type\":\"weapon\",\"name\":\"Worn axe\",\"category\":\"Weapon\",\"rarity\":\"Legendary\",\"quantity\":1,\"description\":\"Ancient skull axe, stained dark from countless hunts, its edge unnaturally keen.\",\"iconPath\":\"legendary_axe.png\",\"base_damage\":25},{\"id\":18,\"type\":\"weapon\",\"name\":\"Worn knife\",\"category\":\"Weapon\",\"rarity\":\"Legendary\",\"quantity\":1,\"description\":\"A femur dagger darkened by age and blood, its grip worn smooth by a generations grip.\",\"iconPath\":\"legendary_knife.png\",\"base_damage\":25},{\"id\":11,\"type\":\"armor\",\"name\":\"Worn bone leggings\",\"category\":\"Armor\",\"rarity\":\"Legendary\",\"quantity\":1,\"description\":\"Thick leather leggings guard the legs from scratches, bites, and rough terrain during hunts.\",\"iconPath\":\"legendary-leggings.png\",\"armor_point\":28},{\"id\":17,\"type\":\"weapon\",\"name\":\"Worn club\",\"category\":\"Weapon\",\"rarity\":\"Legendary\",\"quantity\":1,\"description\":\"A gore-caked wooden club, its surface permanently stained a deep, bloody brown.\",\"iconPath\":\"legendary_club.png\",\"base_damage\":25},{\"id\":10,\"type\":\"armor\",\"name\":\"Worn bone helmet\",\"category\":\"Armor\",\"rarity\":\"Legendary\",\"quantity\":1,\"description\":\"A dome darkened by old blood marks long use in hunts and violent encounters.\",\"iconPath\":\"legendary-cap.png\",\"armor_point\":28},{\"id\":12,\"type\":\"armor\",\"name\":\"Worn bone plate\",\"category\":\"Armor\",\"rarity\":\"Legendary\",\"quantity\":1,\"description\":\"Bone thorax stained with dried blood signal a warrior who has survived many close fights.\",\"iconPath\":\"legendary-plate.png\",\"armor_point\":28},{\"id\":9,\"type\":\"armor\",\"name\":\"Worn bone boots\",\"category\":\"Armor\",\"rarity\":\"Legendary\",\"quantity\":1,\"description\":\"Soft leather footwear wraps the feet to prevent cuts and reduce pain on rocky ground.\",\"iconPath\":\"legendary-boots.png\",\"armor_point\":28}],\"equipped\":{\"weapon\":null,\"armor_cap\":null,\"armor_plate\":null,\"armor_leggings\":null,\"armor_boots\":null},\"stamina\":{\"current\":55,\"max\":100,\"last_reset\":1774940401},\"active_quest\":null}', 'hs_hair_2', 'hs_beard_2', 13, 26, 9, '2026-02-03 19:17:53', '2026-03-31 07:01:59'),
...
(10, 5, 'feketecsegeistvan-40257@taszi.hu', '$2b$10$RC8i1dQ1aK8AZI4lYWv3OOmdNJJJ.9F8rnG85UaEk5I4UnSr89.pu', '$2b$10$RC8i1dQ1aK8AZI4lYWv3OO', 'gipszjakab55', '2026-03-20', 1, 0, 0, '', NULL, 1),
(11, 6, 'asd1', '$2b$10$MTKHOhp8E8ZVywn6xP7ueu1rp3rEdPDZjMpP5gTv5hcIcAk7bk9jO', '$2b$10$MTKHOhp8E8ZVywn6xP7ueu', 'csegef111', '2026-02-28', 1, 0, 0, '', NULL, 1),
(12, 7, 'csege0306@gmail.com', '$2b$10$LVZ7AD02IAgPT4QU479zz.IGfnkcO42HcTuGpCo5ruk8tsnp7kbjK', '$2b$10$LVZ7AD02IAgPT4QU479zz.', 'csegef222', '2026-02-28', 1, 0, 0, '', NULL, 1),
